...
3)  Make a directory called "BIR_OTS_2024", this will be your working directory for the course.
...
6)  Also in Rstudio: Go back up to the "File" tab and select "New Project", then select the "BIR_OTS_2024" directory.
